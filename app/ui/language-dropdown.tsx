  ...
  return (
    <>
      <div className="relative">
        ...
        <div
          className={`absolute -inset-x-5 top-10 z-30 flex flex-col rounded-md bg-white py-4 shadow-lg ${transClass} xs:w-32 xs:-translate-x-6 md:w-40 md:translate-x-0 dark:bg-zinc-800`}
        >
