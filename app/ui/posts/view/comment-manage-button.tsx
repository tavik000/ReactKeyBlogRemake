...
export default function CommentManageButton({
  authorName,
  commentContent,
  onEdit,
  onDelete,
}: CommentManageButtonProps) {
        ...
        >
          ...
          >
            {isAuthor ? (
              ...
              <DropdownItem key="edit" className="hidden text-gray-500 hover:bg-gray-200" />
            )}
        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <p className="text-white">{dict.comment.areYouSureDeleteComment}</p>
